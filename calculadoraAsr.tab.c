...
#ifndef YY_YY_CALCULADORAASR_TAB_H_INCLUDED
# define YY_YY_CALCULADORAASR_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_CALCULADORAASR_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "SUMA", "RESTA", "DIVIDE", "MULTI",
  "EXPON", "MODU", "PAREND", "PARENI", "FINEXP", "NUM", "$accept", "exp",
...
{
       9,    10,     7,     9,    10,     1,     8,     2,    11,    16,
      12,    13,    14,    15,    19,    20,    21,    22,    17,    18
};

static const yytype_int8 yycheck[] =
{
       3,     4,     1,     3,     4,    10,     0,    12,    11,     9,
       5,     6,     7,     8,    12,    13,    14,    15,     9,    10
};
...
{
       0,    10,    12,    14,    15,    16,    17,    15,     0,     3,
       4,    11,     5,     6,     7,     8,     9,    16,    16,    17,
      17,    17,    17
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 51 "calculadoraAsr.y"
                  {printf("resultado = %d\n", recorre((yyvsp[-1].arbol))); exit(0);}
#line 1338 "calculadoraAsr.tab.c"
    break;

  case 3:
#line 54 "calculadoraAsr.y"
                         {(yyval.arbol) = nuevoNodo(1,SUMA,(yyvsp[-2].arbol), (yyvsp[0].arbol));}
#line 1344 "calculadoraAsr.tab.c"
    break;

  case 4:
#line 55 "calculadoraAsr.y"
                         {(yyval.arbol) = nuevoNodo(1,RESTA, (yyvsp[-2].arbol), (yyvsp[0].arbol));}
#line 1350 "calculadoraAsr.tab.c"
    break;

  case 6:
#line 59 "calculadoraAsr.y"
                           {(yyval.arbol) = nuevoNodo(1,MULTI,(yyvsp[-2].arbol),(yyvsp[0].arbol));}
#line 1356 "calculadoraAsr.tab.c"
    break;

  case 7:
#line 60 "calculadoraAsr.y"
                           {(yyval.arbol) = nuevoNodo(1,DIVIDE,(yyvsp[-2].arbol),(yyvsp[0].arbol));}
#line 1362 "calculadoraAsr.tab.c"
    break;

  case 8:
#line 61 "calculadoraAsr.y"
                           {(yyval.arbol) = nuevoNodo(1,EXPON,(yyvsp[-2].arbol),(yyvsp[0].arbol));}
#line 1368 "calculadoraAsr.tab.c"
    break;

  case 9:
#line 62 "calculadoraAsr.y"
                           {(yyval.arbol) = nuevoNodo(1,MODU,(yyvsp[-2].arbol),(yyvsp[0].arbol));}
#line 1374 "calculadoraAsr.tab.c"
    break;

  case 11:
#line 66 "calculadoraAsr.y"
                             {(yyval.arbol) = (yyvsp[-1].arbol);}
#line 1380 "calculadoraAsr.tab.c"
    break;

  case 12:
#line 67 "calculadoraAsr.y"
               {(yyval.arbol) = nuevoNodo(0,(yyvsp[0].valor),NULL, NULL);}
#line 1386 "calculadoraAsr.tab.c"
    break;


#line 1390 "calculadoraAsr.tab.c"
